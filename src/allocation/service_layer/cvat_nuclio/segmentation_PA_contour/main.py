...
from src.allocation.service_layer.cvat_nuclio.segmentation_PA_contour.download import donw_load_function

def init_context(context):
    context.logger.info("Init context...  0%")
    os.makedirs('/opt/nuclio/models', exist_ok=True)
    donw_load_function()
    context.user_data.model_handler = YOLO('/opt/nuclio/models/dentistry_pa-contour_yolov11x-seg_25.22.pt')
